...
public class AbstractAuthFilter extends AbstractAuthenticationProcessingFilter {
        ...
        public AbstractAuthFilter() {
            super(new OrRequestMatcher(
                    ...
                    new AntPathRequestMatcher("/api/users/{\\d+}/image", HttpMethod.PUT),
                    ...
                    new RegexRequestMatcher("/api/news?(.)*filter=SAVED_BY(.)*", HttpMethod.GET),
                    new AntPathRequestMatcher("/api/news/{\\d+}/image", HttpMethod.PUT),
                    new AntPathRequestMatcher("/api/news/{\\d+}/likes", HttpMethod.POST),
                    new AntPathRequestMatcher("/api/news/{\\d+}/dislikes", HttpMethod.POST),
                    new AntPathRequestMatcher("/api/news/{\\d+}/likes", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/api/news/{\\d+}/dislikes", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/api/news/{\\d+}", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/api/news/{\\d+}/reports", HttpMethod.POST),
                    new AntPathRequestMatcher("/api/news/{\\d+}/bookmarks", HttpMethod.POST),
                    new AntPathRequestMatcher("/api/news/{\\d+}/bookmarks", HttpMethod.DELETE),
                    ...
                    new AntPathRequestMatcher("/api/comments/{\\d+}/likes", HttpMethod.POST),
                    new AntPathRequestMatcher("/api/comments/{\\d+}/dislikes", HttpMethod.POST),
