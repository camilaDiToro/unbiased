...
public class AbstractAuthFilter extends AbstractAuthenticationProcessingFilter {
        ...
        public AbstractAuthFilter() {
            super(new OrRequestMatcher(
                    ...
                    new AntPathRequestMatcher("/users/{\\d+}/followers/{\\d+}", HttpMethod.PUT),
                    ...
                    new RegexRequestMatcher("/article?(.)*filter=SAVED_BY(.)*", HttpMethod.GET),
                    new AntPathRequestMatcher("/article/{\\d+}/image", HttpMethod.PUT),
                    new AntPathRequestMatcher("/article/{\\d+}/likes", HttpMethod.POST),
                    new AntPathRequestMatcher("/article/{\\d+}/dislikes", HttpMethod.POST),
                    new AntPathRequestMatcher("/article/{\\d+}/likes", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/article/{\\d+}/dislikes", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/article/{\\d+}", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/article/{\\d+}/reports", HttpMethod.POST),
                    new AntPathRequestMatcher("/article/{\\d+}/bookmarks", HttpMethod.POST),
                    new AntPathRequestMatcher("/article/{\\d+}/bookmarks", HttpMethod.DELETE),
                    new AntPathRequestMatcher("/article", HttpMethod.POST),
