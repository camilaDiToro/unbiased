...
<form:form cssClass="form-signin" modelAttribute="registerForm" action="${postUrl}" method="post">
    ...
    <div>
        <form:label path="email" cssClass="sr-only">Email address</form:label>
        <form:input type="text" path="email"  cssClass="form-control" placeholder="Email address" required="" autofocus=""/>
                    <form:errors path="email" element="p" cssStyle="color: red"/>
    </div>
    <div>
