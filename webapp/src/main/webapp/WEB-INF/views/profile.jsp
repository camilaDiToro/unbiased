...
&lt;%&ndash;            <div>&ndash;%&gt;
&lt;%&ndash;                <div>&ndash;%&gt;
&lt;%&ndash;                    <div style="margin-left: 5%; margin-top: 2%; font-family: 'Helvetica Neue', sans-serif; font-weight: 700; font-size: 42px">&ndash;%&gt;
&lt;%&ndash;                        Alejo Caeiro&ndash;%&gt;
&lt;%&ndash;                    </div>&ndash;%&gt;
&lt;%&ndash;                </div>&ndash;%&gt;

&lt;%&ndash;                &lt;%&ndash;    <div style="border-left:1px grey; border-right:1px solid grey; height:100%; opacity: 50%"></div>&ndash;%&gt;&ndash;%&gt;
&lt;%&ndash;            </div>&ndash;%&gt;
        ...
        <div class="d-flex flex-row">
                                        ...
                                        <div class="d-flex flex-column justify-content-between w-60">
                                            <div class="d-flex w-100">
                                                ...
                                                <div class="card-body-home">
                                                    ...
                                                    <h6 class="card-subtitle py-1 text-ellipsis"><c:out value="${article.subtitle}"/></h6>
                                                    <p class="text-sm-left text-secondary mb-0"><c:out value="${fullNews.readTime}"/> <spring:message code="home.read"/></p>
                                                        &lt;%&ndash;                                    <p class="card-text"><c:out value="${fn:substring(article.body, 0, maxLength)}${fn:length(article.body) > maxLength ? '...' : ''}"/></p>&ndash;%&gt;
                                            ...
                                            <div class="d-flex justify-content-between p-2 w-100">
                                                ...
                                                <div class="d-flex align-items-center" role="group">
                                                    ...
                                                    <c:if test="${user != null}">
                                                        ...
                                                        &lt;%&ndash;                                                    <button type="button" class="btn btn-sm btn-outline-primary m-1 h-75 max-h-40px"><svg class="h-75" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 4H5a2 2 0 0 0-2 2v15l3.467-2.6a2 2 0 0 1 1.2-.4H19a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"></path></svg></button>&ndash;%&gt;
                                                </div>
                                            </div>
                                        </div>
            ...
            &lt;%&ndash;RIGHT SIDE&ndash;%&gt; &lt;%&ndash;copiado&ndash;%&gt;
