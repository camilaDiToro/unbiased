                                                ...
                                                <div class="d-flex align-items-center" role="group">
                                                    ...
                                                    <c:if test="${loggedUser != null}">
                                                        <div class=" m-1 h-50 max-h-40px d-flex justify-content-center align-items-center" >
                                                            <img style="width: 24px !important;" id="bookmark" onclick="handleBookmarkClick(this)" class="svg-btn svg-bookmark" src="<c:url value="/resources/bookmark${saved ? '-clicked' : ''}.svg"/>" alt="" url="<c:url value="/news/${article.newsId}/save"/>">
                                                        </div>
                                                    </c:if>
